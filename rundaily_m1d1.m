...
% Path of the project
ras_file = 'C:\Users\MVG5545\Documents\Research\RAS_runs\Runs_forecastMH\m1_d1\test.prj';
% Path of plan text file
planfile = 'C:\Users\MVG5545\Documents\Research\RAS_runs\Runs_forecastMH\m1_d1\test.p01';
tempplanfile = 'C:\Users\MVG5545\Documents\Research\RAS_runs\Runs_forecastMH\m1_d1\test_temp.p01';
% Path of flow text file
flowfile = 'C:\Users\MVG5545\Documents\Research\RAS_runs\Runs_forecastMH\m1_d1\test.u02';
tempflowfile = 'C:\Users\MVG5545\Documents\Research\RAS_runs\Runs_forecastMH\m1_d1\test_temp.u02';
% Path of previous model (e.g. for day 1 use observed model path)
prevmodel = 'C:\Users\MVG5545\Documents\Research\RAS_runs\Runs_forecastMH\obs\';

% Starting and ending of simulation (NOTE: INCREASE ONE DAY TO THE START
% DAY FOR EACH LEAD TIME)
start_day = 23; start_month = 12; start_year = 2007;
...
%***************************** RUN THE MODEL ******************************
% Show the period that the model is currently running
disp('CURRENT WORK:')
disp([starting_date, ' ', starting_hour, ' - ',ending_date,' ',ending_hour])
% Call comp_ras function. Run the model
bool_run = comp_ras_hidewindow(RC,ras_file,true(1));
...
for d = 2 : length(date) - 1
    ...
    restart_file = [str_rst_flname,prevmodel,str_nameprj,str_nameplan,...
